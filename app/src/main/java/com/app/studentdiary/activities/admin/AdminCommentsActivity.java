...
public class AdminCommentsActivity extends AppCompatActivity implements Info {
...
//        Initializing recyclerview and dialog boxes
    ...
    private void initRv() {
        ...
        typeRecyclerViewAdapter
                = new TypeRecyclerViewAdapter(this, superList, RvType.RV_TYPE_COMMENTS_ADMIN);
        recyclerView.setAdapter(typeRecyclerViewAdapter);
    }

    private void initData() {
//        Fetching data from firebase
        DatabaseReference reference = Utils.getReference().child(NODE_ADMIN_COMMENTS);
